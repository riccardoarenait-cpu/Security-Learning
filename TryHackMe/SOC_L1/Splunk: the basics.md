...
Forwarder: Agent installed on an endpoint collecting the data

Indexer: processes the data and categorizes it

Head: place where users can search the indexed logs
