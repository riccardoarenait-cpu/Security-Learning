...
**Man in the middle** = occurs when the victim believes they're communicating with a trusted destination, but the attacker in the middle of the conversation changes the message and the destination acts on it
How it works:
